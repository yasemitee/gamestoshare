        ...
        <AnimatedContentWrapper>
          ...
          <div className="mt-14">
            ...
            <ContentParagraph>
              ...
              "our", and "us". By accessing or using the platform, you agree to
              be bound by these Terms and Conditions. If you do not agree to
              these Terms and Conditions, you must not use GTS.
            </ContentParagraph>
            <ContentParagraph className="mb-16">
              ...
              platform, the usage of Steam data, and the responsibilities of
              both GTS and its users.
            </ContentParagraph>
            ...
            <div className="space-y-16">
              ...
              <ContentSection title="1. Purpose of GTS">
                ...
                <ContentParagraph className="">
                  GTS does not create, manage, modify, or facilitate the
                  creation of Steam Family Sharing groups. Users may decide to
                  communicate outside of GTS and use Steam Family Sharing
                  independently. Any Steam Family Sharing arrangements occur
                  entirely outside of GTS.
                </ContentParagraph>
              </ContentSection>
              ...
              <ContentSection title="3. About Steam Family Sharing and Compliance">
                <ContentParagraph>
                  ...
                  established by Valve Corporation. Users should carefully
                  review the Steam Subscriber Agreement and all rules concerning
                  Family Sharing, including restrictions that specify that Steam
                  Family Sharing is intended for family members or trusted users
                  and that it may be restricted or revoked by Valve at any time.
                </ContentParagraph>
                <ContentParagraph>
              ...
              <ContentSection title="4. Use of the Steam Web API">
                ...
                />
                <ContentParagraph className="">
                  Users understand that making a Steam library or wishlist
                  public on Steam is a personal choice and may have privacy
                  implications. GTS encourages users to review their Steam
                  privacy settings before using the platform.
                </ContentParagraph>
              </ContentSection>
              ...
              <ContentSection title="5. User Responsibilities">
                ...
                <Subsection number="5.2" title="Compliance With Steam Policies">
                  <ContentParagraph className="mb-6">
                    You agree to comply with the Steam Subscriber Agreement,
                    Steam Family Sharing rules, and all other Steam policies.
                  </ContentParagraph>
                </Subsection>
                ...
                <Subsection number="5.4" title="Prohibited Use">
                  ...
                  />
                  <ContentParagraph className="">
                    GTS reserves the right to suspend or terminate user access
                    for behavior that violates these Terms.
                  </ContentParagraph>
                </Subsection>
              </ContentSection>
              ...
              <ContentSection title="7. Intellectual Property and Ownership">
                <ContentParagraph>
                  GTS does not claim ownership of any content sourced from
                  Steam. All Steam related content including but not limited to:
                </ContentParagraph>
                <NumberedList
                  items={[
                    'Game titles.',
                ...
                />
                <ContentParagraph>
                  belongs to Valve Corporation and the respective rights
                  holders.
                </ContentParagraph>
                <ContentParagraph>
                  GTS only displays such information as permitted by the Steam
                  Web API Terms of Use.
                </ContentParagraph>
                <ContentParagraph className="">
                  All original content on GTS including website design, text,
                  and branding is owned by GTS unless otherwise stated.
                </ContentParagraph>
              </ContentSection>
              ...
              <ContentSection title="8. Liability and Disclaimer">
                <ContentParagraph>
                  GTS is provided on an "as is" and "as available" basis. We
              ...
              <ContentSection title="9. Third Party Services">
                <ContentParagraph>
                  GTS interacts with the Steam Web API, which is operated by
                  Valve Corporation. GTS does not control, manage, or guarantee
                  the availability or behavior of the Steam Web API.
                </ContentParagraph>
                <ContentParagraph>
              ...
              <ContentSection title="10. Privacy Policy Summary">
                <ContentParagraph>
                  Although GTS may provide a separate Privacy Policy, this
                  section summarizes how data is handled:
                </ContentParagraph>
                <NumberedList
                  items={[
              ...
              <ContentSection title="11. Changes to the Platform">
                <ContentParagraph>
                  GTS may introduce new features, update existing ones, or
                  remove parts of the platform at any time. These Terms apply to
                  all versions of the service.
                </ContentParagraph>
                <ContentParagraph className="">
                  Users will be informed of substantial changes, and continued
              ...
              <ContentSection title="12. Termination">
                <ContentParagraph>
                  GTS reserves the right to suspend or terminate access if a
                  user:
                </ContentParagraph>
                <NumberedList
                  items={[
              ...
              <ContentSection title="13. Governing Law">
                <ContentParagraph className="">
                  ...
                  Any disputes arising from the use of GTS will be subject to
                  the exclusive jurisdiction of the courts of Milan, Italy.
                </ContentParagraph>
              </ContentSection>
